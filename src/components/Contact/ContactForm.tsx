	...
	return (
		<div className="w-full">
			...
			>
				...
				>
					<label className="block text-nude-dark-2 font-semibold text-lg mb-2 font-balqis">
						Nom & Prénom
					</label>
					<input
						type="text"
						...
						required
						autoComplete=""
						className={`h-12 sm:h-14 rounded-xl bg-beige-light backdrop-blur-sm px-4 w-full border-2 border-nude-dark ${
				...
				>
					...
					<input
						...
						autoComplete="off"
						className="h-12 sm:h-14 rounded-xl bg-beige-light backdrop-blur-sm px-4 w-full border-2 border-nude-dark focus:border-rose-200 focus:outline-none transition-all duration-300 text-lg text-gray-400"
						{...register("commande")}
					/>
				</motion.div>
				...
				>
					...
					<textarea
						...
						required
						autoComplete="off"
						className={`rounded-xl bg-beige-light backdrop-blur-sm p-2 sm:p-4 w-full border-2 border-nude-dark ${
				...
				>
					<button
						...
						className={`w-full mt-8 rounded-xl border-2 border-nude-light bg-nude-dark hover:bg-rose-dark text-nude-light hover:text-nude-dark hover:border-nude-dark duration-300   backdrop-blur-sm h-12 sm:h-14 text-lg cursor-pointer shadow-lg hover:shadow-xl hover:scale-105 transition-all ${
