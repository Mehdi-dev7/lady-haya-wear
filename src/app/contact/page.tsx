...
export default function Contact() {
	return (
		<section className="bg-rose-light-2 min-h-screen">
			<div className="container mx-auto px-4 sm:px-6 md:px-8 lg:px-8 pt-32 pb-16">
				...
				>
					...
					<p className="text-lg md:text-xl text-nude-dark-2 font-balqis max-w-2xl mx-auto">
				...
				<motion.div
					...
					className="bg-gradient-to-br from-rose-light to-nude-light rounded-3xl shadow-2xl overflow-hidden"
				>
					{/* Bordure décorative */}
					<div className="h-2 bg-gradient-to-r from-logo via-rose-dark-2 to-nude-dark"></div>

					{/* Contenu principal */}
					<div className="flex flex-col lg:flex-row min-h-[600px]">
						{/* Section gauche - Formulaire */}
						<div className="lg:w-[60%] p-8 lg:p-12 bg-white/80 backdrop-blur-sm">
							<ContactLeft />
						</div>

						{/* Section droite - Informations */}
						<div className="lg:w-[40%] p-8 lg:p-12 bg-gradient-to-br from-nude-light/50 to-rose-light/50 backdrop-blur-sm">
							<ContactRight />
						</div>
					</div>
				</motion.div>
				...
				>
					<div className="bg-white/60 backdrop-blur-sm rounded-2xl p-8 shadow-lg">
						<h3 className="text-2xl font-balqis text-logo mb-4">
							Notre Engagement
						</h3>
						<p className="text-nude-dark-2 leading-relaxed max-w-3xl mx-auto">
