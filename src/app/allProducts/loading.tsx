	...
	return (
		<div className="min-h-screen bg-beige-light">
			...
			<section className="px-4 md:px-8 lg:px-16 xl:px-32 2xl:px-48 py-12 mt-18">
				<div className="text-center">
					<div className="animate-pulse">
						...
						<div className="h-6 bg-nude-light rounded-lg mb-6 max-w-2xl mx-auto"></div>
						<div className="h-8 bg-nude-light rounded-full w-48 mx-auto"></div>
					</div>
				</div>
			</section>
			...
			<section className="px-4 md:px-8 lg:px-16 xl:px-32 2xl:px-48 py-2 mb-16">
				<div className="animate-pulse">
					...
					<div className="flex justify-center items-center gap-2 mt-12">
						<div className="h-10 w-24 bg-nude-light rounded-lg"></div>
						<div className="flex gap-2">
							{[...Array(5)].map((_, i) => (
								<div
									key={i}
									className="h-10 w-10 bg-nude-light rounded-lg"
								></div>
							))}
						</div>
						<div className="h-10 w-24 bg-nude-light rounded-lg"></div>
			...
			<section className="px-4 md:px-8 lg:px-16 xl:px-32 2xl:px-48 bg-rose-light-2 py-16">
				<div className="text-center">
					<div className="animate-pulse">
						<div className="h-12 bg-nude-light rounded-lg mb-4 max-w-lg mx-auto"></div>
						<div className="h-6 bg-nude-light rounded-lg mb-8 max-w-2xl mx-auto"></div>
						<div className="flex flex-col sm:flex-row gap-4 justify-center">
							<div className="h-12 w-32 bg-nude-light rounded-2xl"></div>
							<div className="h-12 w-32 bg-nude-light rounded-2xl"></div>
						</div>
					</div>
				</div>
